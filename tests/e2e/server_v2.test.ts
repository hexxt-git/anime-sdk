/**
 * Integration test for startServerV2 — spawns a real server, hits each route.
 * Uses only AniList (fast, no screenshot needed) to keep runtime manageable.
 */
import { afterAll, beforeAll, describe, expect, it } from 'vitest';
import * as http from 'node:http';
import { startServerV2 } from '../../src/server/index.js';
...
describe('startServerV2 — live integration', () => {
